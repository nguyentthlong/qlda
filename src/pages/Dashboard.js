                                ...
                                <div className="card-bg w-100 border d-flex flex-column">
                                    <div className="p-4 d-flex flex-column h-100">
                                        ...
                                        <div className="mt-3 d-flex justify-content-between">
                                            <CDBContainer
                                                style={{ width: '250px', height: '150px', margin: '0 -4rem' }}
                                                className="p-0"
                                            >
                                                <Pie
                                                    data={data.chart1}
                                            ...
                                            <div className="text-right w-25">
                                                ...
                                                <div>
                                                    <div className="d-flex align-items-center justify-content-between text-success">
                                                        <span
                                                            style={{ fontSize: '3em', margin: '-2rem 0px -1.5rem 0px' }}
                                                        >
                                                            &#8226;
                                                        </span>
                                        ...
                                        <div className="mt-5 d-flex align-items-center justify-content-between">
                                            ...
                                            <div className="text-right d-flex flex-column justify-content-between">
                                                <div className="d-flex align-items-center justify-content-between text-primary">
                                                    <span style={{ fontSize: '3em', margin: '-2rem 0px -1.5rem 0px' }}>
                                                        &#8226;
                                                    </span>
                        ...
                        <footer className="footer">
                            <div className="d-flex align-items-center">
                                ...
                                <span
                                    ...
                                    style={{ fontSize: '3em', margin: '-2rem 0px -1.5rem 1rem', color: '#C4C4C4' }}
                                >
                                    &#8226;
                                </span>
